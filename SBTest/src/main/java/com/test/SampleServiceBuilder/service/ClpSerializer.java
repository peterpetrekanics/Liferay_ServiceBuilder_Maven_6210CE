...
import com.test.SampleServiceBuilder.model.FooClp;
...
public class ClpSerializer {
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.test.SampleServiceBuilder.model.impl.FooImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("com.test.SampleServiceBuilder.NoSuchFooException")) {
            return new com.test.SampleServiceBuilder.NoSuchFooException();
        }
