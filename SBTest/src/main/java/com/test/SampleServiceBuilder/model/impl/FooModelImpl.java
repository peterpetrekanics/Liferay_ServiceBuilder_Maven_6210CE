...
import com.test.SampleServiceBuilder.model.FooModel;
import com.test.SampleServiceBuilder.model.FooSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.test.SampleServiceBuilder.model.FooModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link FooImpl}.
 * </p>
 *
 * @author Joe Bloggs
 * @see FooImpl
 * @see com.test.SampleServiceBuilder.model.Foo
 * @see com.test.SampleServiceBuilder.model.FooModel
 * @generated
 */
@JSON(strict = true)
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a foo model instance should use the {@link com.test.SampleServiceBuilder.model.Foo} interface instead.
     */
    ...
    public static final String TABLE_SQL_CREATE = "create table Foo_Foo (fooId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,field1 VARCHAR(75) null,field2 BOOLEAN,field3 INTEGER,field4 DATE null,field5 VARCHAR(75) null)";
    ...
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.com.test.SampleServiceBuilder.model.Foo"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.com.test.SampleServiceBuilder.model.Foo"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.test.SampleServiceBuilder.model.Foo"),
            true);
    public static long FIELD1_COLUMN_BITMASK = 1L;
    public static long FIELD2_COLUMN_BITMASK = 2L;
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.com.test.SampleServiceBuilder.model.Foo"));
