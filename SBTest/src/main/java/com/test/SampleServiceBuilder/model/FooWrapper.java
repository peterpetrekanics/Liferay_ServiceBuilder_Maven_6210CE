package com.test.SampleServiceBuilder.model;
...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
    ...
    */
    ...
    @Override
    public int compareTo(com.test.SampleServiceBuilder.model.Foo foo) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.test.SampleServiceBuilder.model.Foo> toCacheModel() {
        return _foo.toCacheModel();
    }

    @Override
    public com.test.SampleServiceBuilder.model.Foo toEscapedModel() {
        return new FooWrapper(_foo.toEscapedModel());
    }

    @Override
    public com.test.SampleServiceBuilder.model.Foo toUnescapedModel() {
